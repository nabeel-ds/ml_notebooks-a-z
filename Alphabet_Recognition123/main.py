...
y = pd.read_csv("https://raw.githubusercontent.com/nabeel-ds/Alphabet_Recognition123/labels.csv")["labels"]
...
while(True):
  ...
  try:
    ...
    image_bw_resized = image_bw.resize((1,660), Image.ANTIALIAS)
